...
@Component({
    ...
    templateUrl: './mobile-upload-picture-list.component.html',
                    ...
                    init: {
                        ...
                        'FileUploaded': function (up, file, info) {
                            ...
                            if (self.allUploadPictureInfo.length >= 4) {
                                ...
                                self.allUploadPictureInfo.push(self.uploadPictureInfo);
                                self.picUploadInfoHandler.emit(self.allUploadPictureInfo);
                            }
